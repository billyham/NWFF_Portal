...
require_once 'fiscalsponsorshipapp1retrieve.php';
...
echo <<<_END
        ...
        <form method="post" action="fiscalsponsorshipapp1submit.php" accept-charset="ISO-8859-1" />
...
<br /></p>
        ...
        <textarea name="shortdesc" cols="70" rows="3" wrap="soft" value="$shortdesc">$shortdesc</textarea>
        <br /></p>
        ...
        <p><strong>Synopsis:</strong> Summarize the film's message. (character limit: 4000) <br />
