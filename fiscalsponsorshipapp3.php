...
require_once 'fiscalsponsorshipapp3retrieve.php';
...
echo <<<_END
        ...
        <form method="post" action="fiscalsponsorshipapp3submit.php" accept-charset="ISO-8859-1" />
        ...
        <p><strong>Funding narrative:</strong> Provide a descriptive plan of how you intend to fund this production.
        <br />Include a reasoning of how and why you can expect this production to obtain the
        resources it needs <br /> and how you intend to use the Film Forum's fiscal sponsorship. <br />
        ...
        <textarea name="budget" cols="85" rows="10" wrap="soft" value="$budget">$budget</textarea>
        <br /></p><br />
