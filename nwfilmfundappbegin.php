...
?>
    ...
    <div class="Content">
        <h2>Description</h2>
        <p>
            The 2013 Film Fund provides at least one award of $10,000 to a documentary 
            production in the Northwest. Applications are due July 26, 11:59pm.
        </p>
...
echo <<<_END
        ...
        <form method="post" action="nwfilmfundappbeginsubmit.php" accept-charset="ISO-8859-1" />
...
_END;
        ...
        $query = "select * from billyx_portal.filmfund where applicant_email='$email'";
...
if (mysql_num_rows($result)) {
    ...
    echo '<form method="post" action="nwfilmfundapp1.php" accept-charset="ISO-8859-1" />';
...
_END;
    ...
    echo'<p><strong>No current applications are in progress</strong></p>';
        ...
        $query = "select * from billyx_portal.filmfund where applicant_email='$email' AND submitted='1'";
        $result = mysql_query($query);
