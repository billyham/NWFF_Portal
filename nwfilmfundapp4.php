...
require_once 'nwfilmfundapp4retrieve.php';
...
echo <<<_END
        ...
        the case of shorts) rather than a demo reel or showreel (i.e. a heavily edited sampling<br />
        from many projects). Indicate the applicant's role in the work sample project and if <br>
        necessary, indicate a starting and ending timecode to be viewed. If you are providing <br>
        a link that is password protected, please provide the password in the sample description.<br>
        



        <form method="post" action="nwfilmfundapp4submit.php" accept-charset="ISO-8859-1" />
