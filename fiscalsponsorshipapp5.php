...
require_once 'fiscalsponsorshipapp5retrieve.php';


require_once 'fiscalsponsorshipapp5buildsubmission.php';
...
echo <<<_END
        ...
        <form method="post" action="fiscalsponsorshipapp5submit.php" accept-charset="ISO-8859-1" />
